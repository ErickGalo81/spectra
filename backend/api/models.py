...
class Aluno(models.Model):
    # AQUI ESTÁ A MÁGICA: Ligando o aluno ao professor!
    # Colocamos null=True para não quebrar o banco de dados caso já existam alunos salvos.
    professor = models.ForeignKey(Professor, on_delete=models.CASCADE, related_name='alunos', null=True, blank=True)
